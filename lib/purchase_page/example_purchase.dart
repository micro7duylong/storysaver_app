...
const List<String> _kProductIds = <String>[_weekId, _monthId, _yearId];

class PurchasePageExam extends StatefulWidget {
  const PurchasePageExam({super.key});

  @override
  State<PurchasePageExam> createState() => _PurchasePageExamState();
}

class _PurchasePageExamState extends State<PurchasePageExam> {
